...
def plot_data_generator(energy_lists: list[list[float|None]],
                        data_type: list[int],
                        data_display_styles: dict = None):

    lm_line_length = data_display_styles.get("lm_length", 1.0)
    ts_line_length = data_display_styles.get("ts_length", 0.5)
    line_separation = data_display_styles.get("separation", 0.5)
    ...
    #print the line coordinates and connecting line coordinates for debugging
    print("line_coordiante_list:", line_coordiante_list)
    print("connecting_line_coordinate_list:", connecting_line_coordinate_list)

    line_data = {
        "coordinates": line_coordiante_list,
        "connecting_coordinates": connecting_line_coordinate_list,
        "species_names": None,
        "abscissa_starting_points": abscissa_starting_points,
        "species_name_tilt_angle": 0.0
    }
    return line_data
